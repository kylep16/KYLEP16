...
- Leading **mobile UI/UX design** and maintaining visual consistency across the product
- Designing new product features, user flows, and interactive prototypes in **Figma**
- Translating designs into production-ready interfaces using **TypeScript, TSX, and CSS**
- Building and improving reusable UI components and design systems
- Conducting **QA, usability testing, and A/B testing**
